...
public class BurlapParsingExp extends DistributedExperiment {
	public static final ILogger						LOG	= LoggerFactory
																.create(BurlapParsingExp.class);

	private final LogicalExpressionCategoryServices	categoryServices;

	public BurlapParsingExp(File initFile) throws IOException {
		this(initFile, Collections.<String, String> emptyMap(),
				new BurlapResourceRepo());
	}

	public BurlapParsingExp(File initFile, Map<String, String> envParams,
