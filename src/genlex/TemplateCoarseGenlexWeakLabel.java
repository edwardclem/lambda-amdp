 ...
 */
public class TemplateCoarseGenlexWeakLabel<DI extends ILabeledDataItem<Sentence, ?>> extends
	...
	protected TemplateCoarseGenlexWeakLabel(
	...
	public static class Builder<DI extends ILabeledDataItem<Sentence, ?>> {
		...
		public TemplateCoarseGenlexWeakLabel<DI > build() {
			final GenerationRepository repository = new GenerationRepository();

			return new TemplateCoarseGenlexWeakLabel<DI>(
	...
	public static class Creator<DI extends ILabeledDataItem<Sentence, ?>>
			implements IResourceObjectCreator<TemplateCoarseGenlexWeakLabel<DI>> {

		private final String type;

		public Creator() {
			this("genlex.template.coarse.weaklabel");
		}
		...
		@Override
		public TemplateCoarseGenlexWeakLabel<DI> create(Parameters params,
