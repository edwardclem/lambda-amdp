...
import edu.cornell.cs.nlp.utils.log.*;
...
//modified from GeoExpSimple

public class BurlapExpSimple {
	public static final ILogger LOG = LoggerFactory.create(GeoExpSimple.class);

	private BurlapExpSimple() {
...
//							.addConstantsToOntology(simpleOntology)
							...
							.setUseOntology(true).setNumeralTypeName("n")
		...
		final File seedLexiconFile = new File(resourceDir, "burlap.seed.lex");
